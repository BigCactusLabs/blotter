...
<!-- SECTION:NOTES:BEGIN -->
Landed 2026-08-19 on the recreated repo: .github/workflows/ci.yml — stable job runs build/test/clippy/fmt + doctor --leaks; second job builds --locked --all-features on MSRV 1.89. First run green.
<!-- SECTION:NOTES:END -->
